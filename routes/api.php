...
Route::middleware(['throttle:60,1'])->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('wms')->group(function () {
            ...
            Route::get('/kualitas', [WmsController::class, 'indexKualitas'])->middleware('permission:wms.view');
            Route::get('/tipe-hp', [WmsController::class, 'indexTipeHp'])->middleware('permission:wms.view');

            // [T-43] Import master produk Excel (template → preview → commit via queue)
            Route::get('/produk/import/template', [WmsController::class, 'downloadTemplateProduk'])->middleware('permission:wms.create');
