    ...
    @if($orderSuccess)
        ...
        <div class="max-w-lg mx-auto text-center py-10">
            ...
            <div class="flex gap-3 mt-6 justify-center">
                <a href="{{ route('shop') }}" class="px-5 py-2.5 rounded-xl bg-up-primary text-white font-bold text-sm hover:bg-up-primary-dark transition-colors">Lanjut Belanja</a>
                <a href="{{ route('cart') }}" class="px-5 py-2.5 rounded-xl border border-ink-200 text-ink-700 font-bold text-sm hover:bg-ink-50 transition-colors">Lihat Keranjang</a>
            </div>
        </div>
