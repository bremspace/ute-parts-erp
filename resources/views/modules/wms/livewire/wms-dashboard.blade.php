    ...
    @if($showPoModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div class="w-full max-w-2xl glass-panel p-6 rounded-3xl relative max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex gap-3">
                    <button wire:click="$set('showPoModal', false)" class="flex-1 py-2.5 rounded-xl bg-white/5 text-ink-300 font-semibold text-xs cursor-pointer">Batal</button>
                    <button wire:click="simpanPo" class="flex-1 py-2.5 rounded-xl bg-up-primary text-white font-bold text-xs cursor-pointer">Simpan PO (Draft)</button>
                </div>
            </div>
        </div>
    @endif
    ...
    @if($showSupplierModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div class="w-full max-w-sm glass-panel p-6 rounded-3xl relative">
                ...
                <div class="flex gap-3 pt-4 border-t border-white/5 mt-5">
                    <button wire:click="$set('showSupplierModal', false)" class="flex-1 py-2.5 rounded-xl bg-white/5 text-ink-300 font-semibold text-xs cursor-pointer">Batal</button>
                    <button wire:click="simpanSupplier" class="flex-1 py-2.5 rounded-xl bg-up-primary text-white font-bold text-xs cursor-pointer">Simpan</button>
                </div>
            </div>
        </div>
    @endif
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4" x-data="{ open: true }">
            <div class="w-full max-w-sm glass-panel p-6 rounded-3xl relative" @keydown.escape.window="Livewire.dispatch('alert', {type:'info',message:''})">
                ...
                <div class="space-y-4">
                    ...
                    <button wire:click="bayarPo" class="w-full py-3 rounded-xl bg-up-mint text-ink-950 font-bold text-xs cursor-pointer">Catat Pembayaran</button>
                </div>
            </div>
        </div>
    @endif
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div class="w-full max-w-lg glass-panel p-6 rounded-3xl relative max-h-[90vh] overflow-y-auto">
                ...
                <div class="space-y-3 mb-4">
                    ...
                    <button wire:click="simpanRak" class="w-full py-2.5 rounded-xl bg-up-primary text-white font-bold text-xs cursor-pointer">+ Tambah Rak</button>
                </div>
