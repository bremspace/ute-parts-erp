        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div class="w-full max-w-xl glass-panel p-6 rounded-3xl relative max-h-[90vh] flex flex-col">
                ...
                <div class="flex gap-3 pt-4 border-t border-white/5 mt-4">
                    <button wire:click="$set('showJurnalManual', false)" class="flex-1 py-2.5 rounded-xl bg-white/5 text-ink-300 font-semibold text-xs cursor-pointer">Batal</button>
                    <button wire:click="simpanJurnalManual" class="flex-1 py-2.5 rounded-xl bg-up-primary text-white font-bold text-xs cursor-pointer">Posting Jurnal</button>
                </div>
            </div>
        </div>
    @endif
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div class="w-full max-w-md glass-panel p-6 rounded-3xl relative">
                ...
                <div class="flex gap-3 pt-4 border-t border-white/5 mt-5">
                    <button wire:click="$set('showCoaModal', false)" class="flex-1 py-2.5 rounded-xl bg-white/5 text-ink-300 font-semibold text-xs cursor-pointer">Batal</button>
                    <button wire:click="simpanCoa" class="flex-1 py-2.5 rounded-xl bg-up-primary text-white font-bold text-xs cursor-pointer">Simpan Akun</button>
                </div>
            </div>
        </div>
    @endif
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div class="w-full max-w-sm glass-panel p-6 rounded-3xl relative">
                ...
                @if($utangAktif)
                    ...
                    <div class="flex gap-3 pt-4 border-t border-white/5 mt-5">
                        <button wire:click="$set('showBayarUtangModal', false)" class="flex-1 py-2.5 rounded-xl bg-white/5 text-ink-300 font-semibold text-xs cursor-pointer">Batal</button>
                        <button wire:click="bayarUtang" class="flex-1 py-2.5 rounded-xl bg-up-mint text-ink-950 font-bold text-xs cursor-pointer">Catat Pembayaran</button>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div class="w-full max-w-sm glass-panel p-6 rounded-3xl relative">
                ...
                @if($piutangAktif)
                    ...
                    <div class="flex gap-3 pt-4 border-t border-white/5 mt-5">
                        <button wire:click="$set('showBayarPiutangModal', false)" class="flex-1 py-2.5 rounded-xl bg-white/5 text-ink-300 font-semibold text-xs cursor-pointer">Batal</button>
                        <button wire:click="bayarPiutang" class="flex-1 py-2.5 rounded-xl bg-up-mint text-ink-950 font-bold text-xs cursor-pointer">Catat Penerimaan</button>
                    </div>
                @endif
            </div>
        </div>
